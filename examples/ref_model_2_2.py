...
trans_rate_4 = Parameter('alpha_4', 0.062, 0., 2.,
                         'transmission rate after 4th transition', hidden=False)

trans_rate_5 = Parameter('alpha_5', 0.062, 0., 2.,
                         'transmission rate after 5th transition')

trans_rate_6 = Parameter('alpha_6', 0.062, 0., 2.,
...
bc_model.save_file('ref_model_2_2.pypm')
