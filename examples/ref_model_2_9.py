...
waned_immunity_pop = Population('waned_immunity', 0,
                            'people who lost immunity some time after gaining immunity',
...
bc_model.add_connector(
    Propagator('nat waned immunity', nat_immunized_pop, waned_immunity_pop, nat_waned_fraction, nat_waned_delay))
...
vac_waned_delay_pars = {
    'mean': Parameter('vac_waned_delay_mean', 365., 1., 10000., 'mean time from vaccination immunity to waned immunity'),
...
bc_model.add_connector(
    Propagator('vac waned immunity', immunized_pop, waned_immunity_pop, vac_waned_fraction, vac_waned_delay))

# Once waned, the susceptible population increases

bc_model.add_connector(
    Adder('waned to susceptible', waned_immunity_pop, susceptible_pop))
...
bc_model.save_file('ref_model_2_9.pypm')
