...
reported_fraction_0 = Parameter('report_frac_0', 0.95, 0., 1.,
                            'initial reported fraction', hidden=False)

reported_fraction_1 = Parameter('report_frac_1', 0.96, 0., 1.,
                            'reported fraction after mod 1', hidden=False)

reported_fraction_2 = Parameter('report_frac_2', 0.97, 0., 1.,
                            'reported fraction after mod 2')

mod_reported_fraction_time_1 = Parameter('report_frac_time_1', 50, 0, 800,
                              'time of mod reported frac 1',
                              parameter_type='int', hidden=False)

mod_reported_fraction_time_2 = Parameter('report_frac_time_2', 100, 0, 800,
                              'time of mod reported frac 2',
                              parameter_type='int')

mod_reported_fraction_nstep_1 = Parameter('report_frac_nstep_1', -1, -1, 800,
                              'number of days to apply report_frac 1 linear modification',
                              parameter_type='int', hidden=False)

mod_reported_fraction_nstep_2 = Parameter('report_frac_nstep_2', -1, -1, 800,
                              'number of days to apply report_frac 2 linear modification',
                              parameter_type='int')

bc_model.add_transition(
    Modifier('mod_report_frac_1', 'rel_days', mod_reported_fraction_time_1, reported_fraction,
             reported_fraction_0, reported_fraction_1, enabled=False, model=bc_model,
             linear = True, n_step=mod_reported_fraction_nstep_1))

bc_model.add_transition(
    Modifier('mod_report_frac_2', 'rel_days', mod_reported_fraction_time_2, reported_fraction,
             reported_fraction_1, reported_fraction_2, enabled=False, model=bc_model,
             linear = True, n_step=mod_reported_fraction_nstep_2))
...
bc_model.save_file('ref_model_2_7.pypm')
