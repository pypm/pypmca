...
trans_rate_1_time = Parameter('trans_rate_1_time', 20, 0, 600,
                              'number of days before 1st transmission rate change',
                              parameter_type='int', hidden=False)

trans_rate_2_time = Parameter('trans_rate_2_time', 50, 0, 600,
                              'number of days before 2nd transmission rate change',
                              parameter_type='int', hidden=False)

trans_rate_3_time = Parameter('trans_rate_3_time', 70, 0, 600,
                              'number of days before 3rd transmission rate change',
                              parameter_type='int', hidden=False)

trans_rate_4_time = Parameter('trans_rate_4_time', 75, 0, 600,
                              'number of days before 4th transmission rate change',
                              parameter_type='int', hidden=False)

trans_rate_5_time = Parameter('trans_rate_5_time', 80, 0, 600,
                              'number of days before 5th transmission rate change',
                              parameter_type='int')

trans_rate_6_time = Parameter('trans_rate_6_time', 85, 0, 600,
                              'number of days before 6th transmission rate change',
                              parameter_type='int')

trans_rate_7_time = Parameter('trans_rate_7_time', 180, 0, 600,
                              'number of days before 7th transmission rate change',
                              parameter_type='int')

trans_rate_8_time = Parameter('trans_rate_8_time', 185, 0, 600,
...
vaccination_time = Parameter('vaccination_time', 75, 0, 600,
...
reported_fraction_0 = Parameter('report_frac_0', 0.98, 0., 1.,
                            'initial reported fraction', hidden=False)

reported_fraction_slope = Parameter('report_frac_slope', 0.0001, -0.1, 0.1,
                            'recovery fraction modification slope', hidden=False)

mod_reported_fraction_time = Parameter('report_frac_time', 80, 0, 600,
                              'number of days before start of report_frac linear modification',
                              parameter_type='int', hidden=False)

mod_reported_fraction_nstep = Parameter('report_frac_nstep', -1, -1, 600,
                              'number of days to apply report_frac linear modification',
                              parameter_type='int', hidden=False)

bc_model.add_transition(
    Modifier('mod_report_frac', 'rel_days', mod_reported_fraction_time, reported_fraction,
             reported_fraction_0, reported_fraction_slope, enabled=False, model=bc_model,
...
bc_model.save_file('ref_model_2_6.pypm')
